    ...
    return (
        <section className="my-5">
            <div className="container">
                ...
                <p>Empathy Index is based on five fundamental dimensions. Each of these dimensions displays a distinctive and predictable pattern of relationships with definitive measures that provide a considerable evidence for a multidimensional approach to empathy.</p>
               {
                   information.map(info => (
                    <div className='row'>
                    <div className="col-md-1">
                        <img src={info.img} height="50%" width='100%' alt=""/>
                    </div>
